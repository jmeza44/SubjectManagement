        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrdinalNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CardinalNumber = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courts_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Courts_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduledClasses_Classrooms_ClassroomId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courts_GradeId",
                table: "Courts",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_Courts_SubjectId",
                table: "Courts",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduledClasses_ClassroomId",
